...
Destiny, `N4`), `base6` (Legendary Collection, `LC`), and `ecard1`
(Expedition Base Set, `E1`) done — 14 files. This closes out the Neo series
and opens the e-Card era.

**Remaining gap**: everything older than Diamond & Pearl except
`BS`/`JU`/`FO`/`BS2`/`TR`/`G1`/`G2`/`N1`/`N2`/`SI`/`N3`/`N4`/`LC`/`E1` (the
rest of the WotC/e-Card era, and back). Don't trust this list at face value — run
