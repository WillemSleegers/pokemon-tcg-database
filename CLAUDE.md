...
Destiny, `N4`), and `base6` (Legendary Collection, `LC`) done — 13 files.
This closes out the Neo series.

**Remaining gap**: everything older than Diamond & Pearl except
`BS`/`JU`/`FO`/`BS2`/`TR`/`G1`/`G2`/`N1`/`N2`/`SI`/`N3`/`N4`/`LC` (the rest of
the WotC/e-Card era, and back). Don't trust this list at face value — run
