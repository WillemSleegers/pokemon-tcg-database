...
36 files, plus `ex13` (EX Holon Phantoms, `HP`) — 37 files. This closes
out the Neo series and the e-Card era in full, and opens the EX era and
POP series.

**Remaining gap**: everything older than Diamond & Pearl except
`BS`/`JU`/`FO`/`BS2`/`TR`/`G1`/`G2`/`N1`/`N2`/`SI`/`N3`/`N4`/`LC`/`E1`/`BG`/`E2`/`E3`/`RS`/`SS`/`DR`/`MA`/`TK1A`/`TK1B`/`HL`/`RG`/`P1`/`TRR`/`DX`/`EM`/`UF`/`P2`/`DS`/`LM`/`TK2A`/`TK2B`/`P3`/`HP`
