...
`ex4` (EX Team Magma vs Team Aqua, `MA`) done — 21 files. This closes out
the Neo series and the e-Card era in full, and opens the EX era.

**Remaining gap**: everything older than Diamond & Pearl except
`BS`/`JU`/`FO`/`BS2`/`TR`/`G1`/`G2`/`N1`/`N2`/`SI`/`N3`/`N4`/`LC`/`E1`/`BG`/`E2`/`E3`/`RS`/`SS`/`DR`/`MA`
